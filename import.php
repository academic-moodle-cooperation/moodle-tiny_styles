...
$templatedata = [
    ...
    'instructions3_4_cat_availability' => get_string('instructions_3_4_cat_availability', 'tiny_styles'),
    ...
    'instructions4_5_elem_availability' => get_string('instructions_4_5_elem_availability', 'tiny_styles'),
