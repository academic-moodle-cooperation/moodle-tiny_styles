...
$string['instructions_1_structure_heading'] = 'Struktur';
$string['instructions_1_1_structure_text'] = 'Die Datei muss mit einem Kategorie-Array aufgebaut sein, wobei jede Kategorie ein Element-Array enthält. Dies ist das Format, das jede importierte JSON-Datei befolgen sollte.';
$string['instructions_1_2_visualized_label'] = 'Visualisierung:';
$string['instructions_1_3_visualized_code'] = "Kategorien: [ kategorie_1, kategorie_2 ... kategorie_n ]\n\nkategorie_1: [ element_a, element_b ... element_n ]\nkategorie_2: [ element_x, element_y ...\n→ mit den Elementen, die Stilinformationen enthalten";
$string['instructions_2_usage_heading'] = 'Verwendung der JSON-Datei';
$string['instructions_2_1_usage_text'] = 'Die Beispiel-JSON-Datei kann direkt bearbeitet und durch Kopieren erweitert werden.';
$string['instructions_3_fill_heading'] = 'Wie man die JSON-Datei definiert:';
$string['instructions_3_1_fill_note'] = '(Siehe unten für Erklärungen zu den verschiedenen Optionen.)';
...
$string['instructions_4_expl_heading'] = 'Erklärungen';
$string['instructions_4_1_expl_intro'] = 'Die Felder Name und Beschreibung sollten selbsterklärend sein.';
$string['instructions_4_2_fields_title'] = 'Weitere Optionen sind:';
$string['instructions_5_cat_heading'] = 'Kategorie:';
$string['instructions_5_1_cat_menumode'] = 'wie die Elemente im Editor angezeigt werden (<code>submenu</code> / <code>inline</code> / <code>divider</code>)';
$string['instructions_5_2_cat_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), Standard: <code>0</code>';
$string['instructions_6_elem_heading'] = 'Element:';
$string['instructions_6_1_elem_type'] = '<code>inline</code> oder <code>block</code>';
$string['instructions_6_1_1_elem_type_note'] = 'inline für kurze Texte oder Wörter; block für Absätze oder längere Textblöcke';
$string['instructions_6_2_elem_cssclasses'] = 'CSS-Stil für den Text';
$string['instructions_6_2_1_elem_cssclasses_note'] = 'Dies kann <a href="https://developer.mozilla.org/de/docs/Learn_web_development/Core/Styling_basics/Getting_started#inline-styles" target="_blank">Inline-CSS</a> (z.B. <code>color: red; font-weight: bold;</code>) oder Bootstrap-Klassen sein';
$string['instructions_6_3_elem_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), Standard: <code>0</code>';
$string['instructions_6_4_elem_custom'] = '<code>1</code>, wenn Inline-CSS verwendet wird';
$string['instructions_7_good_heading'] = 'Wissenswertes';
$string['instructions_7_1_good_list'] = '<ul> <li>Kategorien können mehrfach importiert werden. Dies verhindert unbeabsichtigte Löschungen oder Änderungen.<br><strong>Empfehlung:</strong> Verwenden Sie die Beispiel-Datei als Grundlage für Importe.</li> <li>Alle Felder können später über die Moodle-Administrationsoberfläche bearbeitet werden.</li> <li>Icons müssen derzeit manuell über die Kategorienverwaltung in Moodle zugewiesen werden.</li> </ul>';
