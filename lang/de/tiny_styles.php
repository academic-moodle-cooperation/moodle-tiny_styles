...
$string['bootstrapclasses'] = 'Bootstrap-Klassen';
$string['boxes'] = 'Boxen';
...
$string['inlinecss'] = 'Inline-CSS-Stil';
...
$string['instructions_3_3_cat_menumode'] = 'die Elemente einer Kategorie können dargestellt werden als <code>submenu</code> (Untermenü mit dem Namen der Kategorie als Menüeintrag), <code>inline</code> (direkt im Editor angezeigt) oder die Kategorie kann als <code>divider</code> verwendet werden (um Inhalte voneinander zu trennen, hier können keine Elemente hinzugefügt werden)';
$string['instructions_3_4_cat_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), standardmäßig: 0';
...
$string['instructions_4_5_elem_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), standardmäßig: 0';
...
$string['manualstyle'] = 'Manueller Stil';
...
$string['menumodetype_help'] = '<p>Wählen Sie aus, wie Elemente im Menü der Gestaltungsvorlagen angezeigt werden sollen:</p><ul><li><strong>Untermenü</strong>: Die Elemente werden als Untermenü mit dem Namen der Kategorie als übergeordnetem Knoten angezeigt.</li><li><strong>Inline</strong>: Die Elemente der Kategorie werden nacheinander direkt im Menü der Gestaltungsvorlagen angezeigt.</li><li><strong>Trennlinie</strong>: Möglichkeit, um Inhalte im Menü durch eine Linie getrennt voneinander anzuzeigen. Dieser Kategorieart können keine Elemente hinzugefügt werden!</li></ul>';
...
$string['privacy:metadata'] = 'Das TinyMCE Gestaltungsvorlagen Plugin speichert keine personenbezogenen Daten.';
