...
$string['instructions:0:toggle'] = 'Anleitung zur Vorbereitung der Konfigurationsdatei für den Import.';
$string['instructions:1:structure_heading'] = 'Struktur';
$string['instructions:1:1:structure_text'] = 'Die Datei muss mit einem Kategorie-Array aufgebaut sein, wobei jede Kategorie ein Element-Array enthält. Dies ist das Format, das jede importierte JSON-Datei befolgen sollte.';
$string['instructions:1:2:visualized_label'] = 'Visualisierung:';
$string['instructions:1:3:visualized_code'] = "Kategorien: [ kategorie_1, kategorie_2 ... kategorie_n ]\n\nkategorie_1: [ element_a, element_b ... element_n ]\nkategorie_2: [ element_x, element_y ...\n→ mit den Elementen, die Stilinformationen enthalten";
$string['instructions:2:usage_heading'] = 'Verwendung der JSON-Datei';
$string['instructions:2:1:usage_text'] = 'Die Beispiel-JSON-Datei kann direkt bearbeitet und durch Kopieren erweitert werden.';
$string['instructions:3:fill_heading'] = 'Wie man die JSON-Datei definiert:';
$string['instructions:3:1:fill_note'] = '(Siehe unten für Erklärungen zu den verschiedenen Optionen.)';
...
$string['instructions:4:expl_heading'] = 'Erklärungen';
$string['instructions:4:1:expl_intro'] = 'Die Felder Name und Beschreibung sollten selbsterklärend sein.';
$string['instructions:4:2:fields_title'] = 'Weitere Optionen sind:';
$string['instructions:5:cat_heading'] = 'Kategorie:';
$string['instructions:5:1:cat_menumode'] = 'wie die Elemente im Editor angezeigt werden (<code>submenu</code> / <code>inline</code> / <code>divider</code>)';
$string['instructions:5:2:cat_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), Standard: <code>0</code>';
$string['instructions:6:elem_heading'] = 'Element:';
$string['instructions:6:1:elem_type'] = '<code>inline</code> oder <code>block</code>';
$string['instructions:6:1:1:elem_type_note'] = 'inline für kurze Texte oder Wörter; block für Absätze oder längere Textblöcke';
$string['instructions:6:2:elem_cssclasses'] = 'CSS-Stil für den Text';
$string['instructions:6:2:1:elem_cssclasses_note'] = 'Dies kann <a href="https://developer.mozilla.org/de/docs/Learn_web_development/Core/Styling_basics/Getting_started#inline-styles" target="_blank">Inline-CSS</a> (z.B. <code>color: red; font-weight: bold;</code>) oder Bootstrap-Klassen sein';
$string['instructions:6:3:elem_enabled'] = 'entweder <code>1</code> (aktiviert) oder <code>0</code> (deaktiviert), Standard: <code>0</code>';
$string['instructions:6:4:elem_custom'] = '<code>1</code>, wenn Inline-CSS verwendet wird';
$string['instructions:7:good_heading'] = 'Wissenswertes';
