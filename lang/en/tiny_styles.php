...
$string['elementsorder'] = 'Order updated successfully';
...
$string['error:missingelements'] = 'Keine Elemente ausgewählt';
$string['error:missingparam'] = 'Fehlende Parameter';
$string['error:recordnotfound'] = 'Record not found';
$string['error:name'] = 'Name must be at least 3 characters.';
...
$string['instructions_0_toggle'] = 'Instructions on how to prepare the configuration file.';
$string['instructions_1_structure_heading'] = 'Structure';
$string['instructions_1_1_structure_text'] = 'The example.json is structured into a category array, where each category contains an element array. This is the format which any JSON file imported should follow.';
$string['instructions_1_2_visualized_label'] = 'Visualized:';
$string['instructions_1_3_visualized_code'] = "Categories: [ category_1, category_2 ... category_n ]\n\ncategory_1: [ element_a, element_b ... element_n ]\ncategory_2: [ element_x, element_y ...\n→ with the elements carrying the styling information";
$string['instructions_2_usage_heading'] = 'How to use the JSON';
$string['instructions_2_1_usage_text'] = 'The example JSON file can be easily used for editing directly and expanded by copying it.';
$string['instructions_3_fill_heading'] = 'How to fill out the JSON file:';
$string['instructions_3_1_fill_note'] = '(See below for further explanations of the different options.)';
$string['instructions_3_2_fill_code'] = "\"categories\": [\n    {\n        \"name\": \"Enter a minimum 3 characters long name here.\",\n        \"description\": \"Write a short category description here.\",\n        \"showdesc\": \"pick one of the following: helptext/tooltip/never\",\n        \"menumode\": \"pick one of the following: submenu/inline/divider\",\n        \"enabled\": 1,\n        \"elements\": [\n            {\n                \"name\": \"enter a descriptive name here\",\n                \"type\": \"pick either inline or block\",\n                \"cssclasses\": \"a valid css styling alert alert-danger\",\n                \"enabled\": 1,\n                \"custom\": 0\n            },\n            ... next elements ...\n        ]\n    },\n    ... possible to add more categories ...\n]";
$string['instructions_4_expl_heading'] = 'Explanations';
$string['instructions_4_1_expl_intro'] = 'The naming and description fields are self-explanatory.';
$string['instructions_4_2_fields_title'] = 'The further options are:';
$string['instructions_5_cat_heading'] = 'Category:';
$string['instructions_5_1_cat_menumode'] = 'how elements are displayed in the editor (<code>submenu</code> / <code>inline</code> / <code>divider</code>)';
$string['instructions_5_2_cat_enabled'] = 'either <code>1</code> (enabled) or <code>0</code> (disabled), default: <code>0</code>';
$string['instructions_6_elem_heading'] = 'Element:';
$string['instructions_6_1_elem_type'] = 'inline or block';
$string['instructions_6_1_1_elem_type_note'] = 'inline is for styling short text or words; block is for paragraphs or larger text blocks';
$string['instructions_6_2_elem_cssclasses'] = 'CSS styling for the text';
$string['instructions_6_2_1_elem_cssclasses_note'] = 'This can be <a href="https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Styling_basics/Getting_started#inline_styles" target="_blank">inline CSS styles</a> (e.g. <code>color: red; font-weight: bold;</code>) or Bootstrap classes';
$string['instructions_6_3_elem_enabled'] = 'either <code>1</code> (enabled) or <code>0</code> (disabled), default: <code>0</code>';
$string['instructions_6_4_elem_custom'] = '<code>1</code> if using custom CSS inline code';
$string['instructions_7_good_heading'] = 'Good to know';
$string['instructions_7_1_good_list'] = '<ul> <li>Categories can be imported multiple times. This avoids accidental deletions or edits.<br><strong>Suggestion:</strong> Use the example file as the basis for imports to prevent duplicates.</li> <li>All fields can be edited later via Moodle admin pages.</li> <li>Currently, icon selection must be done manually through the Moodle admin category editor.</li> </ul>';
