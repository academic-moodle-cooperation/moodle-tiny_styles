...
$string['view'] = 'View';
$string['visibility'] = 'Availability in TinyMCE editors';
...
$string['visibility_element_help'] = '<p>Restrict general availability for this element in TinyMCE editors.</p><p>"Hide" will hide this element for all users and deactivate all other visibility settings.</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "Show".</p>';
$string['visibility_help'] = '<p>Restrict general availability for this category in TinyMCE editors.</p><p>"Hide" will hide this category for all users and deactivate all other visibility settings.</p>';
