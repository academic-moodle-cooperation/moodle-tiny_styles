...
$string['view'] = 'View';
$string['visibility'] = 'Availability in text editors';
...
$string['visibility_admin_element_help'] = '<p>Restrict visibility for this element based on whether or not the user is a site admin.</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "all users". Otherwise, it is locked to the same restriction as the category (site admins only / non-admins only).</p>';
$string['visibility_admin_help'] = '<p>Restrict visibility for this category based on whether or not the user is a site admin.</p><p>Setting the restriction to "site admins only" or "non-admins only" will lock all of this category\'s elements to the same restriction.</p>';
$string['visibility_admin_locked'] = 'A status restriction was set in this element\'s parent category. This element is bound by the same restriction and cannot be edited. <a href="{$a}">Go to category settings</a>';
$string['visibility_admin_non_admins'] = 'Non-admins only';
$string['visibility_admin_section'] = 'Visibility by site admin status';
$string['visibility_element_help'] = '<p>Restrict general availability for this element in text editors.</p><p>"Hide" will hide this element for all users and deactivate all other visibility settings.</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "Show".</p>';
$string['visibility_help'] = '<p>Restrict general availability for this category in text editors.</p><p>"Hide" will hide this category for all users, deactivate all other visibility settings, and lock the availability of all child elements to "Hide" until this setting is restored.</p>';
$string['visibility_hidden_locked'] = 'This element\'s parent category was set to "Hide". Change the category setting to make this element available in a text editor. <a href="{$a}">Go to category settings</a>';
$string['visibility_hide'] = 'Hide';
$string['visibility_roles'] = 'Visible for role/s';
$string['visibility_roles_element_help'] = '<p>Restrict visibility for this element based on roles.</p><p>Restricting by role is only possible if the above setting is set to "all users" or "non-admins only".</p><p>The available roles are the same as the current selection in this element\'s parent category.</p>';
$string['visibility_roles_help'] = '<p>Restrict visibility for this category based on roles.</p><p>Restricting by role is only possible if the above setting is set to "all users" or "non-admins only".</p><p>This category\'s elements will be limited in their equivalent setting to the current selection.</p>';
$string['visibility_roles_restricted'] = 'A role restriction was set in this element\'s parent category. The selection pool is limited to the current category setting. <a href="{$a}">Go to category settings</a>';
