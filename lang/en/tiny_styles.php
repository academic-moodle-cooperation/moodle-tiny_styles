...
$string['instructions_2_1_structure_text'] = 'The JSON file for TinyMCE Styles has to follow a specific structure. It consists of a category array, where each category contains further element arrays.';
$string['instructions_3_cat_intro'] = 'The following options are available with <strong>categories:</strong>';
$string['instructions_3_1_cat_name'] = 'name of the category, is visible in the editor';
$string['instructions_3_2_cat_description'] = 'description of the category, now visible for admins only';
$string['instructions_3_3_cat_menumode'] = 'the elements of a category can be displayed as <code>submenu</code> (submenu with the category\'s name as parent node), <code>inline</code> (displayed directly in the editor) or the category could be used as a <code>divider</code> (to separate content, where no elements can be added)';
$string['instructions_3_4_cat_enabled'] = 'either <code>1</code> (enabled) or <code>0</code> (disabled), default: 0';
$string['instructions_4_elem_intro'] = 'The following options are available with <strong>elements:</strong>';
...
$string['instructions_5_2_example_code'] = "\"categories\": [\n    {\n        \"name\": \"Category 1\",\n        \"description\": \"Description to category 1\",\n        \"menumode\": \"submenu\",\n        \"enabled\": 1,\n        \"elements\": [\n            {\n                \"name\": \"Element A\",\n                \"type\": \"block\",\n                \"cssclasses\": \"alert alert-info\",\n                \"enabled\": 1,\n                \"custom\": 0\n            },\n            {\n                \"name\": \"Element B\",\n                \"type\": \"inline\",\n                \"cssclasses\": \"color: red; font-weight: bold;\",\n                \"enabled\": 1,\n                \"custom\": 1\n            },\n        ]\n    },\n    {\n        \"name\": \"Category n\",\n        ...\n    },\n]";
$string['instructions_6_good_heading'] = 'Good to know';
$string['instructions_6_1_good_list'] = '<ul> <li>Categories can be imported multiple times. This avoids accidental deletions or edits.</li> <li>All fields can be edited later via the administration site of the plugin.</li> <li>Currently, icon selection must be done manually through category\'s settings.</li> </ul>';
