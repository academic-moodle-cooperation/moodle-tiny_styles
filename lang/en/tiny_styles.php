...
$string['visibility_admin_element_help'] = '<p>Restrict visibility for this element based on whether or not the user is a site admin.</p><p>This setting can only be edited if the equivalent setting of the parent category is set to "all users". Otherwise it is locked to the same restriction as the category.</p>';
...
$string['visibility_roles_element_help'] = '<p>Restrict visibility for this element based on roles.</p><p>Restricting by role is only possible if the above setting is set to "all users" or "non-admins only".</p><p>The available roles are limited to the current selection in this element\'s parent category.</p>';
