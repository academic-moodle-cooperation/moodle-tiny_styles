...
$string['instructions_3_2_2_cat_symbol'] = 'any free Font Awesome 6 solid icon name, without prefix or extension (e.g. <code>book</code>, <code>star</code>, <code>circle-info</code>); the plugin uses FA 6.7.2 bundled with Moodle\'s Boost theme, browse all icons at: <a href="https://fontawesome.com/search?o=r&amp;m=free&amp;s=solid" target="_blank">fontawesome.com</a>';
$string['instructions_3_2_cat_description'] = 'description of the category';
...
$string['instructions_3_4_cat_availability'] = 'either <code>1</code> (show) or <code>0</code> (hide), default: 1';
$string['instructions_3_5_cat_showdesc'] = 'controls how the description is shown to editors: <code>never</code> (hidden), <code>helptext</code> (? button), or <code>tooltip</code> (hover); default: never';
$string['instructions_3_6_cat_visibility_admin'] = 'admin-based visibility: <code>all</code> (all users), <code>admins_only</code> (site admins only), or <code>non_admins</code> (non-admins only). Default: all.';
$string['instructions_3_7_cat_visibility_roles'] = 'array of numeric Moodle role IDs that can see this category; an empty array means all roles can see it. <br> The role IDs are site-specific, find yours at <strong>Site administration &gt; Users &gt; Permissions &gt; Define roles</strong>. Typical defaults: <code>1</code> Manager, <code>3</code> Teacher, <code>4</code> Non-editing teacher, <code>5</code> Student (IDs may differ on your instance)';
...
$string['instructions_4_5_elem_availability'] = 'either <code>1</code> (show) or <code>0</code> (hide), default: 1';
$string['instructions_4_6_elem_visibility_admin'] = 'admin-based visibility: <code>all</code> (all users), <code>admins_only</code> (site admins only), or <code>non_admins</code> (non-admins only). Default: all.<br>Cannot be less restrictive than the parent category.';
$string['instructions_4_7_elem_visibility_roles'] = 'array of numeric Moodle role IDs that can see this element. An empty array means all allowed roles can see it. <br> The role IDs are site-specific, find yours at <strong>Site administration &gt; Users &gt; Permissions &gt; Define roles</strong>. Typical defaults: <code>1</code> Manager, <code>3</code> Teacher, <code>4</code> Non-editing teacher, <code>5</code> Student (IDs may differ on your instance). <br>These are limited to the roles selected in the parent category.';
...
$string['restrict_availability_section'] = 'Availability';
...
$string['view'] = 'View';
$string['visibility'] = 'Availability in TinyMCE editor';
$string['visibility_admin'] = 'Visible for';
$string['visibility_admin_admins_only'] = 'Site admins only';
$string['visibility_admin_all'] = 'All users';
$string['visibility_admin_element'] = 'Visible for';
$string['visibility_admin_element_help'] = '<p>Restrict visibility for this element based on whether or not the user is a site admin.</p><p>Restricting by status is only possible if the above setting for availability is set to "show".</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "all users". Otherwise, it is locked to the same restriction as the category (site admins only / non-admins only).</p>';
$string['visibility_admin_help'] = '<p>Restrict visibility for this category based on whether or not the user is a site admin.</p><p>Restricting by status is only possible if the above setting for availability is set to "show".</p><p>Setting the restriction to "site admins only" or "non-admins only" will lock all of this category\'s elements to the same restriction.</p>';
$string['visibility_admin_locked'] = 'A status restriction was set in this element\'s parent category. This element is bound by the same restriction and cannot be edited, see the current selection below (site admins only / non-admins only). <a href="{$a}">Go to category settings</a>';
$string['visibility_admin_non_admins'] = 'Non-admins only';
$string['visibility_admin_section'] = 'Visibility by site admin status';
$string['visibility_element'] = 'Availability in TinyMCE editor';
$string['visibility_element_help'] = '<p>Restrict general availability for this element in the TinyMCE editor.</p><p>"Hide" will hide this element for all users and deactivate all other visibility settings.</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "Show".</p>';
$string['visibility_help'] = '<p>Restrict general availability for this category in the TinyMCE editor.</p><p>"Hide" will hide this category for all users and deactivate all other visibility settings.</p>';
$string['visibility_hidden_locked'] = 'This element\'s parent category was set to "Hide". Change the category setting to make this element available in a TinyMCE editor. <a href="{$a}">Go to category settings</a>';
$string['visibility_hide'] = 'Hide';
$string['visibility_roles'] = 'Visible for role(s)';
$string['visibility_roles_element'] = 'Visible for role(s)';
$string['visibility_roles_element_help'] = '<p>Restrict visibility for this element based on roles.</p><p>Restricting by role is only possible if the above settings are set to "show" and "all users" or "non-admins only", respectively.</p><p>The available roles are the same as the current selection in this element\'s parent category.</p><p>This element is automatically visible to all roles if none are selected.</p>';
$string['visibility_roles_help'] = '<p>Restrict visibility for this category based on roles.</p><p>Restricting by role is only possible if the above settings are set to "show" and "all users" or "non-admins only", respectively.</p><p>This category\'s elements will be limited in their equivalent setting to the current selection.</p><p>This category is automatically visible to all roles if none are selected.</p>';
$string['visibility_roles_restricted'] = 'A role restriction was set in this element\'s parent category. The selection pool is limited to the current category setting, see the available roles below. <a href="{$a}">Go to category settings</a>';
$string['visibility_roles_section'] = 'Visibility by role';
$string['visibility_show'] = 'Show';
