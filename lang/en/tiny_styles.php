...
$string['instructions_6_1_good_list'] = '<ul> <li>Categories can be imported multiple times. This avoids accidental deletions or edits.</li> <li>All fields can be edited later via the administration site of the plugin.</li></ul>';
