...
$string['restrict_visibility_section'] = 'Restrict visibility';
...
$string['visibility_element_help'] = '<p>Restrict general visibility for this element in text editors.</p><p>"Hide in editor" will deactivate all other restrictive visibility settings.</p><p>Setting can only be edited if the equivalent setting of the parent category is set to "show in editor".</p>';
$string['visibility_help'] = '<p>Restrict general visibility for this category in TinyMCE editors.</p><p>"Hide in editor" will deactivate all other restrictive visibility settings.</p>';
$string['visibility_hidden_locked'] = 'This element\'s parent category was set to "hide". Change the category\'s setting for the element to be visible in a text editor. <a href="{$a}">Go to category settings</a>';
$string['visibility_hide'] = 'Hide in editor';
...
$string['visibility_show'] = 'Show in editor';
